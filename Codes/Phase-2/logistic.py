...
# ── 4) Build & Train Logistic Regression ─────────────────────────────────────
...
disp = ConfusionMatrixDisplay(confusion_matrix=cm,
                              display_labels=logreg_pipeline.named_steps['logisticregression'].classes_)
disp.plot(cmap="Blues", xticks_rotation=45)
plt.title("Logistic Regression Confusion Matrix 01")
plt.tight_layout()
plt.show()
